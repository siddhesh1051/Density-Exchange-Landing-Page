...
const Slider = () => {
  ...
  const cardData = {
    "cardData": [
      { "heading": "You argue with a colleague", "info": "You get angry and defensive, instead of staying open and working towards common ground", "bg": "bg-[#EFEBFF]", "emoji": require("../../public/assets/emoji/thank-you.png") },
