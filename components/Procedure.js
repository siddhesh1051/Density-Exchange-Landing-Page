...
const Procedure = () => {
  return (
    <section className='md:px-4 flex md:mt-40 mt-28 font-[Montserrat]'>
      ...
      viewport={{once:true}}
      className="bg-[#D9F2FF] md:w-full w-[88vw] h-full  rounded-3xl flex flex-col md:p-16 py-8 px-4">
        <motion.div 
        ...
        <Image src='/assets/path.png' width={500} height={500} className='p-2 scale-75 md:scale-100 ' />
        </motion.div>
      </motion.div>
    </section>
  )
